...
make -f make.gefsv12_1mem_p1.dell clobber 
make -f make.gefsv12_1mem_p1.dell
make -f make.gefsv12_1mem_p1.dell install 
make -f make.gefsv12_1mem_p1.dell clobber 

make -f make.gefsv12_1mem_p2.dell clobber 
make -f make.gefsv12_1mem_p2.dell
make -f make.gefsv12_1mem_p2.dell install 
make -f make.gefsv12_1mem_p2.dell clobber 

make -f make.gefsv12_1mem_p3.dell clobber 
make -f make.gefsv12_1mem_p3.dell
make -f make.gefsv12_1mem_p3.dell install 
make -f make.gefsv12_1mem_p3.dell clobber 
