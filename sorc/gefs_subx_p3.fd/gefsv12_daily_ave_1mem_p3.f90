...
!open files for output grib2
     ...
     if(pabbrev=='UGRD'.and.trim(labbrev_short(1:4)).eq.' 10') then
        outfile='ua_10_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='UGRD'.and.trim(labbrev_short(1:4)).eq.' 30') then
        outfile='ua_30_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='UGRD'.and.trim(labbrev_short(1:4)).eq.' 50') then
        outfile='ua_50_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='VGRD'.and.trim(labbrev_short(1:4)).eq.' 10') then
        outfile='va_10_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='VGRD'.and.trim(labbrev_short(1:4)).eq.' 30') then
        outfile='va_30_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='VGRD'.and.trim(labbrev_short(1:4)).eq.' 50') then
        outfile='va_50_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='HGT'.and.trim(labbrev_short(1:4)).eq.' 10') then
        outfile='zg_10_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='HGT'.and.trim(labbrev_short(1:4)).eq.' 30') then
        outfile='zg_30_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='HGT'.and.trim(labbrev_short(1:4)).eq.' 50') then
        outfile='zg_50_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='TMP'.and.trim(labbrev_short(1:4)).eq.' 10') then
        outfile='ta_10_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='TMP'.and.trim(labbrev_short(1:4)).eq.' 30') then
        outfile='ta_30_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='TMP'.and.trim(labbrev_short(1:4)).eq.' 50') then
        outfile='ta_50_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='TMP'.and.trim(labbrev_short(1:4)).eq.' 100') then
        outfile='ta_100_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
     if(pabbrev=='HGT'.and.trim(labbrev_short(1:4)).eq.' 850') then
        outfile='zg_850_GEFS_'//sdy//smn//syr//'_00z_d01_d35_m'//ens_mem(4:5)//'.grb2'
     end if
