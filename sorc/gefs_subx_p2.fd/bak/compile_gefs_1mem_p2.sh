...
ifort -O -I $lib_g2 $sorc_dir/gefs_daily_ave_1mem_p2.f90 $sorc_dir/prlevel.f $sorc_dir/printinfr.f90 $lib_lg2 -lg2_v2.5.0_4 $lib_bacio -lbacio_v2.0.1_4 $lib_lip -lip_v3.0.0_4 $lib_w3 -lw3nco_v2.0.6_4 $lib_sp -lsp_v2.0.2_4 -ljasper -lpng -lz -o $exec_dir/gefs_daily_ave_1mem_p2.exe 
